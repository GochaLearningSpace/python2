...
try:
	#threading.start_new_thread( print_current_time, ("Thread-1", 2, ) )
	thread.start_new_thread( print_current_time, ("Thread-1", 2, ) )
	#threading.start_new_thread( print_current_time, ("Thread-2", 4, ) )
	thread.start_new_thread( print_current_time, ("Thread-2", 4, ) )
	#threading.start_new_thread( print_current_time, ("Thread-3", 3, ) )
	thread.start_new_thread( print_current_time, ("Thread-3", 3, ) )
	#threading.start_new_thread( print_current_time, ("Thread-4", 1, ) )
